    ...
    <div class="content-box f1 p10">
      ...
      >
        <el-table-column label="市级单位统计">
          ...
          <el-table-column prop="name" label="非常满意" width="180" />
          <el-table-column prop="address" label="满意" />
          <el-table-column prop="address" label="基本满意" />
          <el-table-column prop="address" label="不满意" />
        </el-table-column>
      </el-table>
