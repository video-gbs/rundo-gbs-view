...
<template>
  <div class="bg-w">
    <div class="p10 bg-w user-panel-action-box f ai-c">
      <div class="title-css mr10">审核逾期设置</div>
    </div>
    ...
    <div class="p20">
      ...
      <div>
        <el-button type="primary" size="small" @click="setFn">设置</el-button>
      </div>
    </div>
  </div>
</template>
<script>
import { getAuditConfig, setAuditConfig } from "@/api/method/system";
export default {
  name: "",
  data() {
    return {
