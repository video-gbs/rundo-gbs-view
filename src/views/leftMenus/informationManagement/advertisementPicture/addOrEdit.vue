    ...
    <div class="p30">
      <el-form :model="params" label-width="100px" label-position="left">
        ...
        <el-form-item label="关联外部链接">
          <el-row>
            <el-col :span="24"> <el-radio v-model="params.link" size="mini" :label="0">否</el-radio>
              <el-radio v-model="params.link" size="mini" :label="1">是</el-radio>

            </el-col>
          </el-row>

        </el-form-item>
        <el-form-item v-if="params.link" label="链接地址">
          <el-input v-model="params.linkUrl" size="mini" placeholder="请输入外链地址" />
        </el-form-item>
      </el-form>
    </div>
  </div>
